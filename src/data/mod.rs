...
pub struct AppState {
    ...
    #[data(eq)]
    pub tt : HashMap<String, (i32, i32, i32, i32, i32)>,
    pub is_test : bool,
...
fn load_tt_table() -> HashMap<String, (i32, i32, i32, i32, i32)> {
...
pub fn save_tt_table(tt: &mut HashMap<String, (i32, i32, i32, i32, i32)>) {
